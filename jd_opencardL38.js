...
!(async () => {
    console.log('入口：https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=cd2022n4ci22tlj1s2w3245u1mk&shareUuid=01f9ed66c62d4c418822efa47134ba6c')
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                '01f9ed66c62d4c418822efa47134ba6c',
            ]
