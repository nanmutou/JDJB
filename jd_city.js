...
const author_codes = ['4e_-XaQLb2VAYF6ISpeJ5uS0','-ryUXKkMNDFCN0GSSNnHo95ETK2dCBm_','-ryUX6xYNWVHY0PBH9zC_zh6Vklc2Tca','-ryUXf5YM2dFZ0PNSdOWoX0yOa5Pm_-w'].sort(() => 0.5 - Math.random())
const self_code = []
let pool = []
!(async () => {
